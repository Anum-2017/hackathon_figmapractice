  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex justify-center items-center w-[245px] h-[225px] bg-[#f5f5f5] relative overflow-y-hidden">
        ...
        <p className="absolute right-3 top-3 bg-white p-1 rounded-full cursor-pointer hover:bg-[#db4444] hover:text-white">
          <RiDeleteBin6Line />
        </p>
        ...
        <Image className="-mt-8" src={image} alt={productAlt} />
      </div>
      <p>{title}</p>
